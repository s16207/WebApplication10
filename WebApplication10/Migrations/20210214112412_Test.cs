    ...
    public partial class Test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "kutas@wp.pl", "Andrzej", "Test" },
                    { 2, "dupa@wp.pl", "Leon", "Nowak" },
                    { 3, "pipppp@onet.pl", "Piotr", "Dupa" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Na wszystko", "Aspiryna", "Tabs" },
                    { 2, "Na wszystko", "Tabcin", "Pils" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1990, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Andrzej", "Mobobo" },
                    { 2, new DateTime(2021, 2, 14, 12, 24, 11, 421, DateTimeKind.Local).AddTicks(7183), "Lucjan", "Krab" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "duzo", 5, null, null },
                    { 2, 2, "malo", 7, null, null }
                });

            migrationBuilder.InsertData(
                table: "Prescriptions",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "IdPatient" },
                values: new object[] { 1, new DateTime(2021, 2, 14, 12, 24, 11, 424, DateTimeKind.Local).AddTicks(8324), new DateTime(2021, 2, 14, 12, 24, 11, 424, DateTimeKind.Local).AddTicks(9041), 1, 1 });

            migrationBuilder.InsertData(
                table: "Prescriptions",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "IdPatient" },
                values: new object[] { 2, new DateTime(2021, 2, 14, 12, 24, 11, 425, DateTimeKind.Local).AddTicks(763), new DateTime(2021, 2, 14, 12, 24, 11, 425, DateTimeKind.Local).AddTicks(791), 2, 2 });
